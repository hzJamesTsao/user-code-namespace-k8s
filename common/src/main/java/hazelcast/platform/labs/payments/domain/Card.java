...
/* -------------------------------------------------------------------------------------
    Demo: update domain model (Card) by adding an optional field lastTransaction 
    (records last transactionId). Remember to patch existing data in the map using 
    PatchRefdata in refdata-loader.
    ------------------------------------------------------------------------------------- 
*/
/*    
